...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'student_code'     => ['type' => 'varchar', 'constraint' => 225, 'null'=>true],
            'school_id'        => ['type' => 'int', 'constraint' => 11, 'null'=>true, 'comment'=>'only for student'],
            'father_name'      => ['type' => 'varchar', 'constraint' => 255, 'null'=>true],
            'father_mobile'    => ['type' => 'varchar', 'constraint' => 255, 'null'=>true],
